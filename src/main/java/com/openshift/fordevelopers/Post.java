...
public class Post extends PanacheMongoEntity {
    ...
    public String getTitle() {
        return title; // new StringBuilder(title).reverse().toString(); // Should be: return title;
    }

    public String getContent() {
        return content; // new StringBuilder(content).reverse().toString(); // Should be: return content;
    }
